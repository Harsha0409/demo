...
const BusCardModal: React.FC<BusCardModalProps> = ({ isOpen, onClose, bus }) => {
  ...
  const calculateFinalFare = (): FinalFareCalculation & { freshCardPurchase?: number } => {
    ...
    let actualFreshCardDiscount = getFreshCardDiscountAmount(isPurchasingFreshCard, appliedFreshCard, freshCard);
    ...
    try {
      ...
      const payload = {
        ...
        ...(isPurchasingFreshCard && {
          ...
          fresh_card_remaining_balance: getCurrentFreshCardBalance(freshCard, isPurchasingFreshCard, appliedFreshCard, freshCardPurchaseAmount)
        })
      };
      ...
      >
        ...
        <div className="p-3 text-black dark:text-white">
          <div className="flex justify-between">
            <SeatSelection
              ...
              getSeatBackgroundColor={seat => getSeatBackgroundColor(bus, seat)}
            />
        ...
        <div className="flex items-stretch justify-between mt-2 space-x-3 px-3">
          ...
          <FreshCardSection
            ...
            theme={theme}
            getCurrentFreshCardBalance={() => getCurrentFreshCardBalance(freshCard, isPurchasingFreshCard, appliedFreshCard, freshCardPurchaseAmount)}
