...
export function isFreshCardAvailable(freshCard: FreshCard | null | undefined): boolean {
  return !!freshCard && freshCard.available && freshCard.active && freshCard.balance > 0;
}
...
export function getCurrentFreshCardBalance(
  ...
  let balance = freshCard.balance || 0;
